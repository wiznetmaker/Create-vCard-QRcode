...
Scott_vCard = """BEGIN:VCARD
VERSION:3.0
N:Scott
FN:Scott_wiz
ORG:WIZnet Co.
TITLE: Engineer
TEL;TYPE=WORK,VOICE:(02)111-1212
ADR;TYPE=WORK,PREF:;;UI Team;WIZnet R&D Center;South Korea
EMAIL:pentachord@wiznet.io
END:VCARD
"""

Bruno_vCard = """BEGIN:VCARD
VERSION:3.0
N:Bruno
FN:bruno_wiz
ORG:WIZnet Co.
TITLE: Engineer
TEL;TYPE=WORK,VOICE:(02)222-1212
ADR;TYPE=WORK,PREF:;;UI Team;WIZnet R&D Center;South Korea
EMAIL:pentachord@wiznet.io
END:VCARD
"""

Joseph_vCard = """BEGIN:VCARD
VERSION:3.0
N:Joseph
FN:Joseph_wiz
ORG:WIZnet Co.
TITLE: Engineer
TEL;TYPE=WORK,VOICE:(02)333-1212
ADR;TYPE=WORK,PREF:;;UI Team;WIZnet R&D Center;South Korea
EMAIL:pentachord@wiznet.io
END:VCARD
"""

Louis_vCard = """BEGIN:VCARD
VERSION:3.0
N:Louis
FN:Louis_wiz
ORG:WIZnet Co.
TITLE: Engineer
TEL;TYPE=WORK,VOICE:(02)444-1212
ADR;TYPE=WORK,PREF:;;UI Team;WIZnet R&D Center;South Korea
EMAIL:pentachord@wiznet.io
END:VCARD
"""
...
ORG:WIZnet Co.
TITLE: Engineer
TEL;TYPE=WORK,VOICE:(02)555-1212
ADR;TYPE=WORK,PREF:;;UI Team;WIZnet R&D Center;South Korea
EMAIL:pentachord@wiznet.io
END:VCARD
"""
...
oled.text("vCard QR", 0, 0)
oled.text("UI Team", 0, 10)
...
while True:
    ...
    if userinput == "":
        break
    print(userinput)
    if userinput == b"Scott":
        qr.clear()
        qr.add_data(Scott_vCard)
    elif userinput == b"Bruno":
        qr.clear()
        qr.add_data(Bruno_vCard)
    elif userinput == b"Joseph":
        qr.clear()
        qr.add_data(Joseph_vCard)
    elif userinput == b"Louis":
        qr.clear()
        qr.add_data(Louis_vCard)
    elif userinput == b"Hannah":
        qr.clear()
        qr.add_data(Hannah_vCard)
    else:
        qr.clear()
